...
func (d *MockDriver) GetPort() (int, error) {
...
func TestSerialDriverGetPort(t *testing.T) {
	...
	driver := newSerialDriverWithLock(&MockDriver{port: -1, calls: callRecorder}, &MockLocker{calls: callRecorder})
	port, _ := driver.GetPort()
